...
CREATE TABLE IF NOT EXISTS heroes (
    ...
    clase TEXT NOT NULL CHECK(clase IN ('Guerrero','Mago','Arquero','Clérigo','Asesino','Paladín','Bárbaro')),
...
CREATE TABLE IF NOT EXISTS monstruos (
    id INTEGER PRIMARY KEY AUTOINCREMENT,
    nombre TEXT NOT NULL,
    tipo TEXT NOT NULL CHECK(tipo IN ('Dragón','Goblin','No-muerto','Bestia','Elemental','Orco','Otro')),
...
print("Base de datos aventuras.db creada correctamente.")
